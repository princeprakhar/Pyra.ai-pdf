...
const Page = () => {
        ...
        if( typeof window !== "undefined"){
            if(!isLoggedIn){
                toast({
                    ...
                    description: `Signin required to upload the file.`,
                    variant: "destructive",
    ...
    return (
        <div
            className={cn(
                "relative h-full flex-1 my-16 w-full dark:border-2 rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 lg:2xl flex justifiy-center flex-col items-senter",
                {
